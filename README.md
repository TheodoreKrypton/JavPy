...
* [Quick Start](#quick-start)
  * [pip](#with-pip)` install JavPy && javpy`
  * [docker](#with-docker)` pull wheatcarrier/javpy && docker run -p 8081:8081 wheatcarrier/javpy`
  * [git](#with-git)` clone https://github.com/TheodoreKrypton/JavPy.git && cd JavPy && ./build.sh`
