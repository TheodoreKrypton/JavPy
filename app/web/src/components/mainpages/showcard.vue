            ...
            <table>
                <tr>
                    <td v-if="video.actress">
                        <el-button type="primary" plain style="float: left;" @click="onSearch({actress: video.actress})">{{video.actress}}</el-button>
                    </td>
                    ...
                    <td v-else>
                        <el-button type="primary" plain style="float: right;" @click="onSearch({code: video.code})">{{video.code}}</el-button>
                    </td>
                </tr>
            </table>
        </div>
...
import Event from "../../main.js"
    ...
    export default {
        ...
        methods:{
            ...
            onSearch(video){
                Event.$emit('search_jav_by_code', video);
            },
            onMagnet(video){
